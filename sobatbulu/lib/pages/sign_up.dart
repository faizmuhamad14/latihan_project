...
import 'package:sobatbulu_app/pages/syarat_ketentuan.dart';
import 'package:sobatbulu_app/pages/loading.dart';
  ...
  void register() async {
    ...
    if (!_agreeToTerms) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Anda harus menyetujui Syarat & Ketentuan serta Kebijakan Privasi terlebih dahulu'),
        ),
      );
      return;
    }
